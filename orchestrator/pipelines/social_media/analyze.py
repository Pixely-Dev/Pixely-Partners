...
from analysis_modules.q5_influenciadores import Q5Influenciadores
from analysis_modules.q6_oportunidades import Q6Oportunidades
from analysis_modules.q7_sentimiento_detallado import Q7SentimientoDetallado
try:
    # Prefer the UTF-8 copy if available to avoid potential BOM/null-byte issues
    from analysis_modules.q8_temporal_utf8 import Q8Temporal
except Exception:
    from analysis_modules.q8_temporal import Q8Temporal
# Q9 Recomendaciones
...
from analysis_modules.q11_engagement import Q11Engagement
from analysis_modules.q12_comunidad import Q12Comunidad
from analysis_modules.q13_frecuencia import Q13Frecuencia
from analysis_modules.q14_formatos import Q14Formatos
from analysis_modules.q15_hashtags import Q15Hashtags
# Q16 benchmark disabled (commented out per single-client mode)
# from analysis_modules.q16_benchmark import Q16Benchmark
from analysis_modules.q17_sentimiento_agrupado import Q17SentimientoAgrupado
from analysis_modules.q18_anomalias import Q18Anomalias
from analysis_modules.q19_correlacion import Q19Correlacion
from analysis_modules.q20_kpi_global import Q20KpiGlobal
...
ANALYSIS_MODULES = {
    ...
    "Q15": Q15Hashtags
    ,
    # "Q16": Q16Benchmark,  # DISABLED: Q16 commented out to operate in single-client mode
